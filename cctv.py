...
cap = cv2.VideoCapture('rtsp://admin:srivas123@192.168.1.22')
...
output_path = '/home/arun/Downloads/output_video.avi'
...
while True:
    ...
    cv2.namedWindow('Face Mask Overlay', cv2.WINDOW_NORMAL)
